...
module "log-analytics" {
  source                           = "git::https://github.com/cypik/terraform-azure-log-analytics.git?ref=v1.0.0"
  name                             = "app"
  environment                      = "test"
...
# License
This Terraform module is provided under the '[License Name]' License. Please see the [LICENSE](https://github.com/cypik/terraform-azure-log-analytics/blob/master/LICENSE) file for more details.
